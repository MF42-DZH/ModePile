        ...
        mainBlock = GameTextUtilities.TextBlock.of(
            ...
            (skipSpecialThanks
                ...
                : GameTextUtilities.textElems(
                    ...
                    creditText("LEGGINHO", EventReceiver.COLOR_CYAN, 0.65f),
                    ...
                    creditText("IMASIPHY", EventReceiver.COLOR_PINK, 0.65f),
                    creditText("REZAMAULANA98", EventReceiver.COLOR_YELLOW, 0.65f),
                    creditTextNoSp("NALE_IT", EventReceiver.COLOR_GREEN, 0.65f),
                    GameTextUtilities.Text.blankLine(1f),
