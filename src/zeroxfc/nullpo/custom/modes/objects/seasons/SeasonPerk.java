...
public enum SeasonPerk {
    ...
    SUMMER_ACTIVE(1, 450, 0, 3, 6, 12, 30), // Get four I-pieces instantly, pushing the next queue back, and extends the visible next queue.
    ...
    private static class Descriptions {
        ...
        private Descriptions(float baseScale) {
            ...
            springActive = GameTextUtilities.TextBlock.of(
                ...
                GameTextUtilities.Text.custom("(2X LV & 3X BADGES/CLEAR WHEN ACTIVE)", EventReceiver.COLOR_YELLOW, baseScale * 0.6f)
            );
            ...
            summerActive = GameTextUtilities.TextBlock.of(
                ...
                GameTextUtilities.Text.custom("(GET 4 I-PIECES, EXT. NEXT TEMPORARILY)", EventReceiver.COLOR_YELLOW, baseScale * 0.6f)
            );
            ...
            winterActive = GameTextUtilities.TextBlock.of(
                ...
                GameTextUtilities.Text.custom("(0G, 180F LOCK, CLEAR FRZ. WHILE ACTIVE)", EventReceiver.COLOR_YELLOW, baseScale * 0.6f)
            );
        }
    }
